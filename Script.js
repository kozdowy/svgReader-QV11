...
function checkEl(e) {
    if (($(e).prop("tagName") == "ellipse" || $(e).prop("tagName") == "circle" || $(e).prop("tagName") == "rect" || $(e).prop("tagName") == "polyline" || $(e).prop("tagName") == "g" || $(e).prop("tagName") == "polygon" || $(e).prop("tagName") == "path" || $(e).prop("tagName") == "polygon" || $(e).prop("tagName") == "line" || $(e).prop("tagName") == "text") && ($(e).attr("fill") != "none" || $(e).attr("stroke-width"))) {
        return true
    } else {
        return false
    }
	...
	//console.log("count: " + f);
	    ...
	    */
           ...
           if(!((e.Rows.length === 1) && (d === 0))){
            var hot = $.Color(v);
            var ratio = d / i + (1 - d / i) * .001; //if measure == 1, then = 1
